...
def _print_text(payload: dict[str, Any]) -> None:
    ...
    if main:
        ...
        print(f"main_transition_integrity_valid={_safe_dict(main.get('transition_integrity')).get('valid')}")
        print(f"main_transition_integrity_reason={_safe_dict(main.get('transition_integrity')).get('reason_code')}")
        ...
        print(f"main_promotion_authority_approver_kind={_safe_dict(main.get('promotion_authority')).get('approver_kind')}")
        print(f"main_promotion_authority_approver_id={_safe_dict(main.get('promotion_authority')).get('approver_id')}")
        print(f"main_promotion_authority_approver_label={_safe_dict(main.get('promotion_authority')).get('approver_label')}")
        print(f"main_promotion_authority_decided_at={_safe_dict(main.get('promotion_authority')).get('decided_at')}")
        print(f"main_promotion_authority_approver_summary={_safe_dict(main.get('promotion_authority')).get('approver_summary')}")
    ...
    for domain in sorted(_VALID_DOMAINS):
        ...
        print(f"support_{domain}_transition_integrity_valid={_safe_dict(item.get('transition_integrity')).get('valid')}")
        print(f"support_{domain}_transition_integrity_reason={_safe_dict(item.get('transition_integrity')).get('reason_code')}")
        ...
        print(f"support_{domain}_promotion_authority_approver_kind={_safe_dict(item.get('promotion_authority')).get('approver_kind')}")
        print(f"support_{domain}_promotion_authority_approver_id={_safe_dict(item.get('promotion_authority')).get('approver_id')}")
        print(f"support_{domain}_promotion_authority_approver_label={_safe_dict(item.get('promotion_authority')).get('approver_label')}")
        print(f"support_{domain}_promotion_authority_decided_at={_safe_dict(item.get('promotion_authority')).get('decided_at')}")
        print(f"support_{domain}_promotion_authority_approver_summary={_safe_dict(item.get('promotion_authority')).get('approver_summary')}")
    ...
    print(f"db_candidate_fleet_compare_outcome={db_candidate_fleet.get('compare_outcome')}")
    print(f"db_candidate_fleet_rerun_outcome={db_candidate_fleet.get('rerun_outcome')}")
    print(f"db_candidate_fleet_rerun_outcome_summary={db_candidate_fleet.get('rerun_outcome_summary')}")
    print(f"db_candidate_fleet_operator_action={db_candidate_fleet.get('operator_action')}")
