...
def _print_text(payload: dict[str, Any]) -> None:
    ...
    if main:
        ...
        print(f"main_local_to_canonical_state_mapping_summary={_safe_dict(main.get('local_to_canonical_state_mapping')).get('summary_line')}")
    ...
    for domain in sorted(_VALID_DOMAINS):
        ...
        print(f"support_{domain}_local_to_canonical_state_mapping_summary={_safe_dict(item.get('local_to_canonical_state_mapping')).get('summary_line')}")
