...
_FLOW = MainPublishFlowConfig(
    slot="early",
    producer_label="EarlyMainFSJProducer",
    summary_name="main_early_publish_summary.json",
    artifact_type="fsj_main_early_publish_summary",
    report_run_id_prefix_default="fsj-main-early",
    flow_name="fsj_main_early_publish",
)
...
def main() -> None:
    ...
    payload = run_main_publish_flow(
        ...
        producer_factory=EarlyMainFSJProducer,
