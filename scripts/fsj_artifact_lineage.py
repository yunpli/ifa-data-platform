...
def _print_text(payload: dict[str, Any]) -> None:
    ...
    print(f"report_scope={package.get('report_scope')}")
    print(f"output_profile={package.get('output_profile')}")
    print(f"formal_output_root_dir={_safe_dict(package.get('paths')).get('formal_output_root_dir')}")
    print(f"formal_primary_report_path={_safe_dict(package.get('paths')).get('formal_primary_report_path')}")
    print(f"formal_source_report_path={_safe_dict(package.get('paths')).get('formal_source_report_path')}")
