...
def build_status_payload(*, business_date: str, agent_domain: str, history_limit: int = 5, resolution: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "db_candidate_alignment_summary": store.summarize_db_candidate_alignment(active_summary, db_candidates, subject=f"support:{agent_domain}") if active_summary else None,
...
def _print_text(payload: dict[str, Any]) -> None:
    ...
    local_to_canonical_state_mapping = _safe_dict(active.get("local_to_canonical_state_mapping"))
    ...
    print(f"local_to_canonical_state_mapping_summary={local_to_canonical_state_mapping.get('summary_line')}")
