...
def main() -> None:
    ...
    p2.add_argument('--lane', choices=['lowfreq', 'midfreq', 'archive', 'archive_v2', 'highfreq'], required=True)
    ...
    p4.add_argument('--lane', choices=['lowfreq', 'midfreq', 'archive', 'archive_v2', 'highfreq'])
