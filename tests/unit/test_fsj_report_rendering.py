...
def test_main_report_renderer_emits_customer_profile_without_engineering_metadata_in_html() -> None:
    ...
    assert customer_presentation["focus_module"]["contract"]["display_honesty_mode"] == "default_observation_pool_sample"
    assert "默认观察池" in customer_presentation["focus_module"]["why_included"]
