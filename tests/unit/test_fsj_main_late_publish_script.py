...
def test_main_persists_then_publishes_and_writes_summary(
    ...
    assert "llm_boundary_modes=same_day_close llm_override_precedence=deterministic_input_contract>validated_llm_text_fields_only" in operator_summary
    assert "llm_slot_boundary_modes=late:same_day_close llm_forbidden_decision_count=1" in operator_summary
